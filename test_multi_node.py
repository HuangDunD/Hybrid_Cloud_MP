...
NODE_SUM_KEYS = {
    ...
    'ownership_transfer_direct_count',
    'ownership_transfer_wait_count',
    'ownership_transfer_storage_fetch_count',
    'ownership_transfer_push_wait_count',
    'ownership_transfer_push_forward_count',
    'ownership_transfer_lock_request_time',
    'ownership_transfer_wait_lock_success_time',
    'ownership_transfer_wait_push_page_time',
    'ownership_transfer_storage_fetch_time',
    'ownership_transfer_push_forward_time',
    'ownership_transfer_other_time',
                        ...
                        for mode in modes:
                            ...
                            with open(human_path, 'w', encoding='utf-8') as hf:
                                ...
                                stages = [
                                    ...
                                    'ownership_transfer_direct_count','ownership_transfer_wait_count',
                                    'ownership_transfer_storage_fetch_count','ownership_transfer_push_wait_count',
                                    'ownership_transfer_push_forward_count',
                                    'ownership_transfer_lock_request_time',
                                    'ownership_transfer_wait_lock_success_time',
                                    'ownership_transfer_wait_push_page_time',
                                    ...
                                    'ownership_transfer_push_forward_time',
                                    'ownership_transfer_other_time',
                                    'notify_push_page_count','notify_push_page_time','log_flush_count','log_flush_time','log_flush_avg_batch',
