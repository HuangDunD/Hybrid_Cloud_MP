...
extern std::atomic<int64_t> ownership_transfer_direct_count;
extern std::atomic<int64_t> ownership_transfer_wait_count;
extern std::atomic<int64_t> ownership_transfer_storage_fetch_count;
extern std::atomic<int64_t> ownership_transfer_push_wait_count;
extern std::atomic<int64_t> ownership_transfer_push_forward_count;
extern std::atomic<int64_t> ownership_transfer_lock_request_time_ns;
extern std::atomic<int64_t> ownership_transfer_wait_lock_success_time_ns;
extern std::atomic<int64_t> ownership_transfer_wait_push_page_time_ns;
extern std::atomic<int64_t> ownership_transfer_storage_fetch_time_ns;
extern std::atomic<int64_t> ownership_transfer_push_forward_time_ns;
