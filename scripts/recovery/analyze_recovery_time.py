...
使用方法:
    python3 scripts/recovery/analyze_recovery_time.py <compute_log_dir> [node_id1 node_id2 ...]
    python3 scripts/recovery/analyze_recovery_time.py build/compute_server/ 0 1 2
"""
